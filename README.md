...
* **2026-08-19 (v1.3.2 - MTCNN Facial Landmark Alignment, Realtime 2-Way Database Sync & Zero-Flicker Camera UI):**
  ...
  * **Penyederhanaan UI & Clean Screen Camera:** Tombol operasional AI FaceNet disederhanakan menjadi **satu tombol utama** di atas info CPU; layar preview video bersih (*clean screen*) tanpa tombol overlay yang menutupi gambar; serta merampingkan preset kamera ke 3 standar utama (Webcam Browser Direct, IP Camera RTSP, dan Webcam USB).
