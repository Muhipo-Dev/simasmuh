...
* **2026-08-21 (v1.5.6 - Penguatan Keamanan RLS Database, Verifikasi Izin Keluar & Cuti, dan Aksesibilitas Terpadu Navigasi Admin TU):**
  ...
  * **Penyelarasan Identitas Title Bar, Logo Dinamis & Favicon Resmi:**
    ...
    * Menambahkan fitur **Upload Wallpaper Background Master** (`backgroundUrl`) pada panel Pengaturan Sistem untuk mengelola latar belakang terpusat beraksen blur di seluruh halaman login, beranda, dan dashboard.
