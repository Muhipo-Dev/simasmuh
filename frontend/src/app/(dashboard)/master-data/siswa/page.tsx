...
export default function StudentsPage() {
  ...
  return (
    ...
    <div className="space-y-6">
      ...
      {selectedStudentIds.length > 0 && (
        <div className="bg-blue-900 text-white p-4 rounded-2xl shadow-xl flex flex-wrap items-center justify-between gap-4 animate-in fade-in slide-in-from-top-2 border border-blue-700 mb-4">
