...
import { ArrowLeft, Code, Sparkles, LogIn, Menu, Terminal, Cpu } from 'lucide-react'
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col text-slate-900 dark:text-slate-100 transition-colors duration-300">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-16 sm:py-24">
        <div className="max-w-xl w-full text-center space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-100 dark:bg-emerald-950/80 border border-emerald-200 dark:border-emerald-800 text-emerald-700 dark:text-emerald-300 text-xs font-bold shadow-xs">
            <Terminal className="w-4 h-4 text-emerald-600 dark:text-emerald-400" />
            Tentang Tim Developer SIMASMUH
          </div>

          <div className="w-20 h-20 mx-auto rounded-3xl bg-gradient-to-tr from-emerald-600 to-teal-600 text-white flex items-center justify-center shadow-lg shadow-emerald-500/20">
          ...
          <div className="space-y-3">
            ...
            <p className="text-slate-600 dark:text-slate-300 text-sm sm:text-base leading-relaxed max-w-md mx-auto">
              Sistem Informasi Manajemen Sekolah (SIMASMUH) dikembangkan oleh Tim IT &amp; Developer <strong>Muhipo-Dev</strong>. Halaman informasi tim pengembang, teknologi, dan portofolio pengembang sedang disiapkan.
            </p>
          </div>
